...
public class CommunityAdapter extends RecyclerView.Adapter<CommunityAdapter.ViewHolder> {
    private static final String PREFS_NAME = "CommunityAdapterPreferences";

    private List<Songs> songsList;

    public CommunityAdapter(List<Songs> songsList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.comm_song_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.songContributor.setText("Practiced by " + song.getContributor());
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView songContributor;

        public ViewHolder(View itemView) {
            super(itemView);
            songTitle = itemView.findViewById(R.id.songTitle);
            songImage = itemView.findViewById(R.id.songImage);
            songContributor = itemView.findViewById(R.id.songContributor);
        }
    }
}
